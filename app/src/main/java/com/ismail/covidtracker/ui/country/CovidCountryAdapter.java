...
public class CovidCountryAdapter extends RecyclerView.Adapter<CovidCountryAdapter.ViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull CovidCountryAdapter.ViewHolder holder, int position) {
        ...
        holder.tvRecoveredCases.setText(covidCountry.getmRecovered());
        holder.tvDeathsCases.setText(covidCountry.getmDeaths());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView tvTotalCases, tvCountryName,tvRecoveredCases,tvDeathsCases;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tvRecoveredCases = itemView.findViewById(R.id.tvRecoveredCases);
            tvDeathsCases = itemView.findViewById(R.id.tvDeathsCases);
        }
    }
}