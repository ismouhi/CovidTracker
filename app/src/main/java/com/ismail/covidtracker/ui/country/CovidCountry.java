...
public class CovidCountry implements Parcelable {
    String mCovidCountry, mCases, mTodayCases, mDeaths, mTodayDeaths, mRecovered, mActive, mCritical, mFlags,mTests;

    public CovidCountry(String mCovidCountry, String mCases, String mTodayCases, String mDeaths, String mTodayDeaths, String mRecovered, String mActive, String mCritical,String mTests, String mFlags) {
    ...
    public String getmTodayCases() {
        String rsl = mTodayCases;
        if(Integer.parseInt(rsl) > 0){
            rsl = "+"+rsl;
        }
        return rsl;
    }
